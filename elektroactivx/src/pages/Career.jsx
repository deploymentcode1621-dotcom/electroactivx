...
export default function Career() {
  ...
  const testimonials = [
    { quote: "It's rare to work in a place where every single person around you is genuinely driven by both science and purpose. At Elektroactivx, you feel the weight of the mission every day — and it motivates you to give your very best.", name: "Dr. Arindam Adhikari", title: "Director R&D, Lab & Production", photo: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=120&q=85&fit=crop&crop=face" },
    { quote: "You come here knowing you're part of something bigger. The science we do at Elektroactivx is world-class, and knowing our work protects real infrastructure across industries — that sense of impact keeps me going.", name: "Research Scientist", title: "Advanced Materials Division, Mumbai", photo: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=120&q=85&fit=crop&crop=face" },
    { quote: "I joined Elektroactivx because of the science. I stayed because of the people. The collaborative culture here is unlike anything I've experienced — everyone shares knowledge and pushes each other to grow.", name: "Process Engineer", title: "Production & Quality, Navi Mumbai", photo: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=120&q=85&fit=crop&crop=face" },
  ];
  ...
  const news = [
    { date:"March 2024",    tag:"Culture", title:"Elektroactivx opens new advanced materials laboratory in Navi Mumbai",                        img:"https://images.unsplash.com/photo-1532187863486-abf9dbad1b69?w=500&q=85" },
    { date:"January 2024",  tag:"Science", title:"Dr. Wessling publishes landmark paper on conductive polymer corrosion resistance",        img:"https://images.unsplash.com/photo-1581092160562-40aa08e78837?w=500&q=85" },
    { date:"November 2023", tag:"Growth",  title:"Elektroactivx expands product portfolio with new Polyaniline Masterbatch line",               img:"https://images.unsplash.com/photo-1519389950473-47ba0277781c?w=500&q=85" },
  ];

  const faqs = [
    { question:"Can't find a role that suits me?",             answer:"We're always looking for exceptional talent. If you don't see a matching role, send your CV to info@Elektroactivx.co — we'll keep it on file and reach out when the right opportunity arises." },
    { question:"Does Elektroactivx help with relocation?",         answer:"Yes. For senior scientific and technical roles we provide relocation support including housing, travel and settling-in assistance. Please mention your relocation needs during the application process." },
    { question:"Do I need German to work in Germany?",        answer:"English is the primary working language for international roles in Jersbek. German skills are helpful but not required. Our team is multilingual and welcoming." },
    { question:"What kind of employment contracts do you offer?", answer:"We primarily offer full-time permanent contracts. For research collaborations we also arrange fixed-term and consultancy agreements. All roles clearly state their contract type." },
    { question:"Is there an internship or graduate programme?", answer:"Yes — we regularly take on final-year chemistry, chemical engineering and materials science students. We also partner with National Chemical Laboratory, Pune for postgraduate research opportunities." },
  ];
  ...
  return (
    <main className="relative w-full overflow-x-hidden">
      ...
      <section className="relative w-full" style={{height:"62vh",minHeight:440,maxHeight:680}}>
        <div className="absolute inset-0 overflow-hidden">
          <img src="/images/herocareer.jpg" className="w-full h-full object-cover hero-img" alt="careers" style={{objectPosition:"center 35%"}}/>
          <div className="absolute inset-0" style={{background:"linear-gradient(to right,rgba(0,0,0,0.78) 0%,rgba(0,0,0,0.45) 55%,rgba(0,0,0,0.28) 100%)"}}/>
          <div className="absolute inset-0" style={{background:"linear-gradient(to top,rgba(0,0,0,0.6) 0%,transparent 50%)"}}/>
          <div className="absolute inset-0" style={{background:"linear-gradient(135deg,rgba(22,163,74,0.18) 0%,transparent 45%)"}}/>
        </div>
      ...
      <section id="mission" className="w-full bg-white py-20 md:py-28 px-8 md:px-16 lg:px-24">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-14 lg:gap-24 items-start">
          <Reveal from="left" className="lg:w-5/12">
            ...
            <div className="w-8 h-0.5 mb-5" style={{background:"linear-gradient(90deg,#16a34a,#c9a84c)"}}/>
            <p className="text-sm text-gray-500 leading-7 font-light mb-7">
              A career at Elektroactivx is a career on the frontier of materials science. We are a small, focused team doing world-leading work on conductive polymers — and we need people who want to solve problems that have never been solved before.
            </p>
            <a href="#roles" className="inline-block px-8 py-3.5 text-white font-medium text-xs tracking-widest uppercase hover:opacity-90 transition-opacity" style={{background:"#15803d"}}>Find your role</a>
          </Reveal>
          <Reveal from="right" delay={150} className="lg:w-7/12">
      ...
      <section className="w-full border-t border-b border-gray-100" style={{background:"#f9fafb"}}>
        <div className="max-w-7xl mx-auto px-8 md:px-16 lg:px-24">
          <div className="py-5 border-b border-gray-200">
            <p className="text-xs tracking-widest uppercase font-medium text-gray-400 text-center">Elektroactivx by the numbers</p>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 divide-x divide-gray-200">
            {[{target:4,suf:"+",label:"Scientists\non our team"},{target:5,suf:"",label:"Polymer\nproduct lines"},{target:14,suf:"+",label:"Years of\nactive R&D"},{target:2,suf:"",label:"Global\noffices"},{target:100,suf:"%",label:"Science-backed\nformulations"},{target:13,suf:"+",label:"Open roles\nnow hiring"}].map(({target,suf,label},i)=>(
              <Reveal key={i} delay={i*60}>
      ...
      <section className="w-full bg-white py-20 md:py-28 px-8 md:px-16 lg:px-24">
  <div className="max-w-7xl mx-auto">
    <div className="grid grid-cols-1 lg:grid-cols-2 border border-gray-100 overflow-hidden" style={{boxShadow:"0 4px 32px rgba(0,0,0,0.06)"}}>
      
      {/* IMAGE SIDE */}
      <Reveal from="left" className="img-lift overflow-hidden">
        <div className="h-64 md:h-80 lg:h-96 overflow-hidden">
          <img 
            src="/images/work.jpg" 
            alt="Working at Elektroactivx" 
      ...
      {/* TEXT SIDE */}
      <Reveal from="right" delay={120} className="bg-gray-50 p-10 lg:p-14 flex flex-col justify-center">
        <p className="text-xs tracking-widest uppercase font-medium text-gray-400 mb-3">Life at Elektroactivx</p>
        <h2 className="font-light text-gray-900 leading-tight mb-4 tracking-tight" style={{fontSize:"clamp(1.7rem,3vw,2.5rem)"}}>
          Working in<br/><strong className="font-bold">advanced materials</strong>
        </h2>
        <div className="w-8 h-0.5 mb-5" style={{background:"linear-gradient(90deg,#16a34a,#c9a84c)"}}/>
        <p className="text-sm text-gray-500 leading-7 font-light mb-3">
          Our laboratory and production facility in Navi Mumbai is where world-class polymer science meets commercial precision. Every team member contributes to formulations that protect real industrial assets.
        </p>
        <p className="text-sm text-gray-500 leading-7 font-light mb-7">
          Whether you're a scientist or a sales engineer — you are part of a team that takes science seriously, and people even more so.
        </p>
        <a href="#roles" className="text-sm font-medium text-gray-900 underline underline-offset-4 hover:text-green-600 transition-colors w-fit">
          Explore open roles →
        </a>
      </Reveal>
      ...
      {/* 04 — WORKING AT Elektroactivx
<section className="w-full bg-white py-20 md:py-28 px-8 md:px-16 lg:px-24">
  <div className="max-w-7xl mx-auto">
    <div
      className="grid grid-cols-1 lg:grid-cols-2 gap-0 items-stretch border border-gray-100 overflow-hidden"
      style={{ boxShadow: "0 4px 32px rgba(0,0,0,0.06)" }}
    >
      
      <Reveal
  from="left"
  className="img-lift overflow-hidden h-[220px] md:h-[280px] lg:h-[320px]"
>
  <img
    src="/images/work.jpg"
    alt="Working at Elektroactivx"
  ...
  />
      ...
      <Reveal
        from="right"
        delay={120}
        className="bg-gray-50 p-10 lg:p-14 flex flex-col justify-center"
      >
        <p className="text-xs tracking-widest uppercase font-medium text-gray-400 mb-3">
          Life at Elektroactivx
        </p>

        <h2
          className="font-light text-gray-900 leading-tight mb-4 tracking-tight"
          style={{ fontSize: "clamp(1.7rem,3vw,2.5rem)" }}
        >
          Working in <br />
          <strong className="font-bold">advanced materials</strong>
        </h2>

        <div
          className="w-8 h-0.5 mb-5"
          style={{ background: "linear-gradient(90deg,#16a34a,#c9a84c)" }}
        />
        ...
        <a
          href="#roles"
          className="text-sm font-medium text-gray-900 underline underline-offset-4 hover:text-green-600 transition-colors w-fit"
        >
          Explore open roles →
        </a>
      </Reveal>
      ...
      <section className="w-full bg-white border-t border-gray-100 py-20 md:py-28 px-8 md:px-16 lg:px-24">
        <div className="max-w-7xl mx-auto">
          <Reveal className="mb-12">
            <p className="text-xs tracking-widest uppercase font-medium text-gray-400 mb-2 text-center">Benefits</p>
            <h2 className="text-center font-light text-gray-900 tracking-tight" style={{fontSize:"clamp(1.6rem,3vw,2.5rem)"}}>Some perks when joining Elektroactivx</h2>
          </Reveal>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-px" style={{background:"#e5e7eb"}}>
            {perks.map((perk,i)=>(
              <Reveal key={perk.title} delay={i*60}>
          ...
          <Reveal className="mb-12">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
              <div>
                <p className="text-xs tracking-widest uppercase font-medium text-gray-400 mb-2">Open Positions</p>
                <h2 className="font-light text-gray-900 tracking-tight" style={{fontSize:"clamp(1.6rem,3vw,2.5rem)"}}>
                  Roles at Elektroactivx<br/><strong className="font-bold">across all departments</strong>
                </h2>
              </div>
              <p className="text-sm text-gray-400 font-light">13 positions · India & Germany</p>
            </div>
              ...
              <Reveal key={dept.category} delay={i*60}>
                <div className="dept-card bg-white border border-gray-100 overflow-hidden card-lift">
                  <div className="relative overflow-hidden" style={{height:190}}>
                    ...
                    <div className="dept-overlay absolute inset-0 bg-black/35"/>
                    <div className="absolute top-0 left-0 right-0 h-0.5 green-line"/>
                    <div className="absolute top-3 left-3 z-10"><span className="text-white/55 text-xs tracking-widest uppercase font-light">Elektroactivx</span></div>
                    <div className="absolute bottom-0 left-0 right-0 p-4 z-10" style={{background:"linear-gradient(to top,rgba(0,0,0,0.65),transparent)"}}>
                      <p className="text-white font-medium text-sm">{dept.category}</p>
                      <p className="text-white/55 text-xs mt-0.5">{dept.roles.length} open role{dept.roles.length>1?"s":""}</p>
                    </div>
        ...
        <div className="max-w-7xl mx-auto">
          <Reveal className="mb-10">
            <div className="flex items-end justify-between">
              <div>
                <p className="text-xs tracking-widest uppercase font-medium text-gray-400 mb-1">Updates</p>
                <h2 className="font-light text-gray-900 tracking-tight" style={{fontSize:"clamp(1.4rem,2.5vw,2rem)"}}>Latest Elektroactivx news</h2>
              </div>
              <a href="#" className="text-sm font-medium text-gray-500 hover:text-green-600 transition-colors underline underline-offset-4 hidden md:block">All news →</a>
            </div>
          </Reveal>
      ...
      <section className="w-full bg-white border-t border-gray-100 py-20 md:py-28 px-8 md:px-16 lg:px-24">
        <div className="max-w-3xl mx-auto">
          ...
          <Reveal className="mt-10 flex flex-col items-center gap-4">
            <p className="text-sm text-gray-500 font-light">Still have questions? We're happy to help.</p>
            <a href="mailto:info@Elektroactivx.co" className="inline-block px-8 py-3.5 text-white text-xs font-medium tracking-widest uppercase hover:opacity-90 transition-opacity" style={{background:"#15803d"}}>Email Us</a>
          </Reveal>
        </div>
      </section>

{/* 11 — FINAL CAREER CTA + CONTACT */}
<section className="w-full bg-[#0b120d] py-20 md:py-24 px-8 md:px-16 lg:px-24">
  <div className="max-w-7xl mx-auto">
    ...
    <Reveal>
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-8 mb-14">
        ...
        <div className="max-w-xl">
          <p className="text-green-400 text-xs tracking-widest uppercase mb-3">
          ...
          <h2 className="text-white font-light leading-tight mb-4"
            ...
            <span style={{color:"#4ade80"}}>conductive materials</span>
          </h2>

          <p className="text-gray-400 text-sm leading-7 font-light">
            Elektroactivx is an innovation-driven enterprise focused on conductive polymers 
            for industrial applications such as anticorrosion coatings, EMI shielding, 
            antistatic systems and advanced materials engineering.
          </p>
        </div>
    ...
    <Reveal delay={100}>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 border-t pt-10"
        ...
        {/* INDIA */}
        <div>
          <p className="text-white text-sm font-medium mb-2">India (HQ)</p>
          <p className="text-gray-500 text-sm leading-6 font-light">
            Lower Gangapara, Behind Circuit House,<br/>
            Dibrugarh, Assam – 786125
          </p>
          <p className="text-gray-500 text-sm mt-2">📞 9028004416</p>
        </div>

        {/* PUNE */}
        <div>
          <p className="text-white text-sm font-medium mb-2">India (Branch)</p>
          <p className="text-gray-500 text-sm leading-6 font-light">
            604, Ramanbag Society,<br/>
            Shaniwar Peth, Pune – 411030
          </p>
          <p className="text-gray-500 text-sm mt-2">✉ info@Elektroactivx.co</p>
        </div>

        {/* GERMANY */}
        <div>
          <p className="text-white text-sm font-medium mb-2">Germany Office</p>
          <p className="text-gray-500 text-sm leading-6 font-light">
            Am Wischhof 38a<br/>
            D-22941 Jersbek<br/>
            OT Klein Hansdorf
          </p>
          <p className="text-gray-500 text-sm mt-2">✉ bernhard.wessling@Elektroactivx.eu</p>
        </div>
